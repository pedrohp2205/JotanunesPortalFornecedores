...
namespace Jotanunes.Infra.Data.Migrations
{
    ...
    [Migration("20260916184840_AddRequiredWorkerCountAndCreateDocumentsTable")]
    partial class AddRequiredWorkerCountAndCreateDocumentsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jotanunes.Domain.Entities.CompanyWorkSite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CompanyId", "WorkSiteId")
                        .IsUnique()
                        .HasFilter("\"DeletedAt\" IS NULL");

                    b.ToTable("company_work_sites", (string)null);
                });
            ...
            modelBuilder.Entity("Jotanunes.Domain.Entities.Document", b =>
                {
                    ...
                    b.Property<long?>("CompanyWorkSiteId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Jotanunes.Domain.Entities.Document", b =>
                {
                    ...
                    b.HasOne("Jotanunes.Domain.Entities.CompanyWorkSite", "CompanyWorkSite")
                        .WithMany()
                        .HasForeignKey("CompanyWorkSiteId")
                        .OnDelete(DeleteBehavior.Restrict);
